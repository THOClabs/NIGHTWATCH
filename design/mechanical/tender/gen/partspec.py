...
BP04 = [
    Part(
        ...
        "HSS 2 x 2 x 1/8 in", ("hss", 50.8, 3.175, _roof_span_mm()),
        "Cut + weld (AWS D1.1)", _GALV, "Frame square 3 mm/m; diagonal 5 mm", None, 4,
        key_dims_mm={"Member length (each)": _roof_span_mm(), "Members": 4, "Member": "HSS 2x2x1/8",
                     "Corner joints": "fully welded, gusseted"},
        provenance="Roof span/length = P.ENCLOSURE (ASSUMED footprint); 4 perimeter members; size ASSUMED design-intent.",
        notes="Rectangular roll-off roof frame (4 perimeter members). Sizing to be confirmed vs ASCE 7 snow/wind by PE.",
    ),
    Part(
        "NW-RR-002", "Roof rafters / purlins", "BP-04", _A500,
        "HSS 2 x 1 x 1/8 in", ("hss", 38.1, 3.175, _roof_span_mm()),
        "Cut + weld (AWS D1.1)", _GALV, "n/a", None, 5,
        key_dims_mm={"Member length (each)": _roof_span_mm(), "Spacing": 600, "Member": "HSS 2x1x1/8", "Members": 5},
    ...
    Part(
        ...
        "Box track / channel, ~2x roof length", ("hss", 63.5, 4.0, 2 * _roof_len_mm()),
        "Cut + weld / bolt to piers", _GALV, "Rail straightness 3 mm over run; gauge 2 mm", None, 2,
        key_dims_mm={"Rail length (each)": 2 * _roof_len_mm(), "Rails": 2, "Gauge (rail spacing)": _roof_span_mm(),
